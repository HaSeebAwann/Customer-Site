...
export default function Footer() {
    ...
    return (
        <Box sx={{ backgroundColor: "black" }}>
            <Grid container spacing={2} style={{ backgroundColor: "black", color: "white", boxSizing: 'border-box', padding: "30px" }}>
                <Grid item xs={12} sm={12} md={6}>
                    <Grid container spacing={2}>
                        <Grid item xs={4}>
                            <Typography variant="h6" sx={{paddingBottom:'10px'}} >Quick Links</Typography>
